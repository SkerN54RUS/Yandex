...
class Apple(GameObject):
    ...
    def randomize_position(self, snake_positions=None):
        """Создаем рандомную позицию яблока."""
...
class Snake(GameObject):
    ...
    def __init__(self, length=LENGTH, direction=RIGHT,
                 next_direction=RIGHT, last=None
                 ):
    ...
    def reset(self, length=LENGTH, direction=RIGHT,
              next_direction=RIGHT, last=None
              ):
...
def main():
    ...
    while True:
        ...
        if (
            snake.length > CHECKED_LENGTH
            and snake.get_head_position() in snake.positions[CHECKED_LENGTH:]
        ):
            snake.reset()
